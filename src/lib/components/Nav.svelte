<script lang="ts">
	import { drawerOpenStore, setDrawerOpenStore, themeModeStore } from '$lib/stores/uiStore';
...
<div class="navbar relative dark:bg-black">
	<div class="max-w-7xl mx-auto px-4 sm:px-6">
		<div class="flex justify-between items-center border-b-2 border-gray-100">
			<div class="flex justify-between min-w-full md:min-w-0">
				<div class={`md:hidden mt-4 ${themeMode === 'dark' ? 'bg-black' : ''}`}>
					<button
						on:click={() => setDrawerOpenStore(true)}
						type="button"
			...
			<div class="justify-between space-x-5 align-bottom hidden lg:flex">
				<a href="https://github.com/sytanta" target="_blank" rel="noreferrer nofollow">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink"
						aria-hidden="true"
						role="img"
						class="dark:text-gray-50 h-6 w-6 hover:dark:text-gray-400 hover:text-gray-400"
						width="0.97em"
						height="1em"
				...
				<a href="https://github.com/sytanta" target="_blank" rel="noreferrer nofollow">
					<svg
						class="dark:text-gray-50 h-6 w-6 hover:dark:text-blue-400 hover:text-blue-400"
						fill="none"
						viewBox="0 0 24 24"
					>
						<path
				...
				<button on:click={toggleThemeMode} class="link">
					{#if themeMode === 'dark'}
						<svg
							xmlns="http://www.w3.org/2000/svg"
					...
					{:else}
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-6 w-6 hover:dark:text-yellow-400 hover:text-yellow-400"
							viewBox="0 0 20 20"
							fill="currentColor "
						>
							<path
	...
	>
		...
		<button
			on:click={() => setDrawerOpenStore(false)}
			type="button"
		...
		<div class="py-4 overflow-y-auto my-12">
			<ul class="space-y-2">
				<li>
					<button class="ml-2" on:click={toggleThemeMode}>
						{#if themeMode === 'dark'}
							<svg
								xmlns="http://www.w3.org/2000/svg"
